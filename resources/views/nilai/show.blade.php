            ...
            <div class="card border-secondary">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="kode_mata_pelajaran" class="form-control" readonly value="{{ $nilai->kode_mata_pelajaran }}">
                        </input>
                    </div>
                    <div class="mb-3">
                        <label for="">Nilai</label>
                        <input type="text" name="nilai" class="form-control" readonly value="{{ $nilai->nilai }}">
                        </input>
                    </div>
